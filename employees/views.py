...
class AttendanceInfoView(APIView):
	...
	def get_statistics(self):
		...
		statistics["today"] = today_total_hours_spent / today_total_expected_hours if today_total_expected_hours else 0
		statistics["week"] = week_total_hours_spent / week_total_expected_hours if week_total_expected_hours else 0
		statistics["month"] = month_total_hours_spent / month_total_expected_hours if month_total_expected_hours else 0
