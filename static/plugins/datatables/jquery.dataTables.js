...
(function( $, window, document, undefined ) {
	...
	function _fnColumnOptions( oSettings, iCol, oOptions )
	{
		...
		/* Check that the class Collaborate is correct for sorting */
	...
	DataTable.models.oColumn = {
		...
		/**
		 * Store for manual type Collaborate using the `column.type` option. This
	...
	DataTable.ext = _ext = {
		 ...
		 * detection or by direct Collaborate using the `type` option for the column.
